...
本文说明 Bursar 保护什么、不保护什么，以及运维方需要自行提供的加固基线。漏洞私下报告方式见 [SECURITY.zh-CN.md](../../SECURITY.zh-CN.md)。

## Bursar 的前提假设

Bursar 是你自己机器的控制面，它假设：
...
Bursar 不是多租户隔离边界。能够在计算节点提权到 root 的用户，可以绕过节点本地的所有策略执行。
