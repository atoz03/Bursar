...
SSH_GUARD_EXCLUDE_USERS="root gpuops" ENABLE_USER_SLICE_CPU_RESERVE=1 USER_SLICE_CPU_RESERVE_PERCENT=90 USER_SLICE_MEMORY_RESERVE_GB=8 HOME_RESERVE_GB=8 CONTROLLER_URL=http://192.0.2.10:60039 AGENT_TOKEN=<replace-with-agent-token> bash scripts/install_agent_local.sh && \
