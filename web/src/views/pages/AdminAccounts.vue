  ...
  <div class="admin-accounts-page">
    ...
    <el-card class="section-card provision-card">
      ...
      <div class="provision-actions">
        ...
        <el-button @click="openDecryptor">打开密钥破解器</el-button>
      </div>
    </el-card>
    ...
    <el-card class="section-card">
      ...
      <el-table :data="provisionLogs" stripe size="small" max-height="280">
        <el-table-column prop="created_at" label="开通时间" min-width="172" />
    ...
    <el-dialog v-model="provisionResultVisible" title="节点账号开通结果" width="900px" destroy-on-close>
      <template v-if="provisionResult">
        ...
        <div class="kv-row">
          <span class="kv-label">密钥破解器地址</span>
        ...
        <el-form-item label="加密密钥串（完整复制）">
          ...
          <div class="payload-actions">
            ...
            <el-button type="primary" @click="openDecryptor">打开密钥破解器</el-button>
          </div>
        </el-form-item>
      </template>
      <template #footer>
...
import { Clock, Connection, Key, List, Search, UserFilled } from "@element-plus/icons-vue";
...
function openDecryptor() {
  window.open("/key-decryptor", "_blank", "noopener");
}
